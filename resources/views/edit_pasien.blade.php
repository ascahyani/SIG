                                ...
                                <div class="card m-b-20">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="custom-select" name="faskes">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="date" value="2011-08-19" name="mulai_pengobatan" value="{{$pasien->tanggal_mulaipengobatan}}" id="example-date-input">
                                            </div>
                                        </div>
