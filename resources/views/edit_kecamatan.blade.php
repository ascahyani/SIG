                                ...
                                <div class="card m-b-20">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="example-text-input" name="luas_daerah" value="{{$kec->luas_daerah}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="example-text-input" name="jumlah_penduduk" value="{{$kec->kepadatan_penduduk}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="example-text-input" name="kepadatan_penduduk" value="{{$kec->kepadatan_penduduk}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="example-text-input" name="tahun" value="{{$kec->tahun}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="custom-select" name="bulan" value="{{$kec->bulan}}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="example-text-input" name="area" value="{{$kec->area}}">
                                            </div>
                                        </div>
